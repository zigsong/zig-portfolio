    ...
    works: [
      {
        ...
        title: '비바리퍼블리카(토스)\n- 론프로덕트팀',
        period: '2025.03~',
        intro: "대출 중개 서비스 '내게 맞는 대출 찾기'로 대출에 혁신을 일으킨다.",
        ...
        learnings: [
          {
            ...
            desc: (
              <>
                <div>
                  사업자 가심사 요청에 필요한 정부24 문서 추가를 위해 필요한 퍼널들을 디자이너와
                  논의하여 인증 단계에서부터 스크래핑 단계까지 자연스러운 플로우로 제품을 기획 및
                  개발했습니다.
                </div>
                <div>
                  키바나 로그를 활용한 지표 분석을 통해 사용자들이 이탈하는 지점을 파악하고,
                  프론트에서의 비동기 병렬 처리 개수 제한 및 UI 개선을 통해 사용자가 딜레이 경험을
                  줄이도록 개선했습니다.
                </div>
              </>
            ),
            ...
            desc: (
              <>
                <div>
                  ...
                  활성화할 수 있는 케이스를 고려하여 제품의 영향도를 확장했습니다.
                </div>
                <div>
                  카드 청구서 넛지 우선노출 기준의 3-4가지 복잡한 조건들을 정리하여, 우선순위에 맞는
                  적합한 아이템을 노출하면서도 유지보수가 가능한 코드를 작성했습니다.
                </div>
              </>
            ),
          },
        ],
        site: '토스 > 대출 받기 > 가심사 퍼널 및 대출 관리',
      },
    ],
  },
  {
