        ...
        learnings: [
          {
            ...
            desc: (
              <>
              <div>
                우리가게클릭, 알뜰배달, 배민1플러스 등 배민셀프서비스의 핵심이 되는 광고상품 프론트엔드 개발을 담당했습니다.
              </div>
              <div>
                복잡한 비즈니스 로직이 얽혀있는 광고신청 스텝 플로우를 개선하여 새로운 광고상품 신설 및 종료 시에도 유연하게 대응이 가능한 구조를 설계했습니다.
              </div>
              </>
            )
          },
          {
            ...
            desc: (
              <>
                <div>
                  리뷰 사장님 댓글 자주쓰는문구 기능에 순서를 부여하여 사장님들이 문구를 보다 편리하게 붙여넣으실 수 있도록 UX를 개선했습니다. 
                  (개발자가 제안한 기능이 호평을 받아 전체 실에 공유되었습니다.)
                </div>
                <div>
          ...
          },
          {
            ...
            desc: (
              <>
                ...
                <div>
                  사내 레포지토리/라이브러리 정보를 필터와 검색을 통해 조회하는 기능 및 라이브러리 인기 차트, 댓글 기능을 구현했습니다.
                </div>
                <div>
