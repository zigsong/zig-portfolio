    ...
    learnings: [
      {
        ...
        desc: (
          <>
            <div>
              약 2년 간 사내 웹프론트테크트리 워킹그룹의 리더를 맡아 5명의 팀원들과 함께 서비스의
              기획 및 개발을 이끌어나갔습니다.
            </div>
            <div>
      ...
      },
      {
        ...
        desc: (
          <>
            ...
            <div>
              Nest.js와 TypeORM을 이용하여 사내 프론트엔드 레포지토리 정보 및 사용중인 라이브러리
              정보의 매핑 테이블을 구현하여 사내 다양하게 흩어져 있는 기술 정보들을 한눈에 볼 수
              있도록 구현했습니다.
            </div>
          </>
        ),
    ...
    learnings: [
      {
        ...
        desc: (
          <>
            <div>
              리뷰 사장님 댓글 자주쓰는문구 기능에 순서를 부여하여 사장님들이 문구를 보다 편리할 수
              있도록 UX를 개선했습니다.
            </div>
            <div>
      ...
      },
      {
        ...
        desc: (
          <>
            ...
            <div>
              테스트 실행 단위를 분리하여 CI 테스트 수행 속도를 180s에서 140s로 개선했습니다. 또한
              테스트 코드를 구현 세부사항과 분리시키고, enzyme 테스트 코드를 react-testing-library로
              마이그레이션하여 편리하고 유의미한 테스트 코드를 작성하기 위한 기반을 구축했습니다.
            </div>
            <div>
              gitlab API를 이용한 CI 스크립트를 통해 Deploy MR(Merge Request) 본문 작성을 자동화하여
              스프린트 배포에 포함되는 작업을 정리하는 시간을 대폭 줄였습니다.
            </div>
            <div>
      ...
      },
      {
        ...
        desc: (
          <>
            <div>
              서비스 진입 시 노출되는 팝업을 제어할 수 있는 어드민 개발에 참여하여 신규 팝업 개발에
              소요되는 시간을 일주일에서 약 6시간으로 단축했습니다.
            </div>
            <div>
              사내 해커톤(우아톤)에 참여하여 AI를 활용한 가게 콘텐츠보드 검수 자동화 프로덕트 개발의
              프로토타입을 만들었습니다. 이후 실제 과제로 진행되어 모니터링 정확도가 31.5%p
              개선되었으며, 개인정보 차단 콘텐츠의 79%를 사전에 검출할 수 있게 되었습니다.
            </div>
          </>
        ),
      },
