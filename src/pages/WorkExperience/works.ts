...
export default [
  ...
  },
  {
    ...
    learnings: [
      ...
      'Open Layers와 Cesium 등의 3D 관련 라이브러리를 이용함에 따라 서비스가 상당히 무거웠는데, 실제 타겟 사용자인 건설현장의 사양이 낮은 데스크탑에서도 무리없이 사용할 수 있도록 성능을 고려해야 했습니다. React Profiler 등의 툴을 사용하여 컴포넌트가 불필요하게 렌더링되는 경우를 개선하기 위해 고민했습니다.',
      '여러 컴포넌트에서 사용하는 로직을 custom hook으로 분리하여 재사용성을 높였습니다.',
      'grid 형태로 구현되어 있던 CSS를 PC/태블릿/모바일 환경에서 확인할 수 있도록 반응형 페이지를 제작했습니다. 사용자의 접속 환경(디바이스)을 detect하여 그에 맞게끔 UI를 조정했습니다.',
    ],
