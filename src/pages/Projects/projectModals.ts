...
export const noltoModal = {
  ...
  learnings: [
    ...
    '서버 상태 관리와 api 요청과 응답의 틀을 마련하기 위해 react-query를 사용했습니다. custom error code를 매핑하여 http 에러 발생 시 HttpError 인스턴스에 알맞는 에러 메시지를 전달할 수 있도록 했습니다.',
    ...
    '기술스택 자동완성을 위한 백엔드 api를 호출 시 http 요청 수를 조절하기 위해 debounce를 구현했습니다.',
